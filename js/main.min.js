...
const setTheme=themeName=>{
    ...
    document.querySelectorAll("img.theme-toggle-btn").forEach(
        img=>{
            img.src=themeName==="theme-dark"?"https://someshkar.com/icons/moon.png":"https://someshkar.com/icons/sun.png";
...
function submitListener(e){
    ...
    switch(input.value.toLowerCase()){
        ...
        case"clear":    removeAllMainNodes();break;
        case"about":    renderAbout();break;
        case"education":renderEducation();break;
        case"skills":   renderSkills();break;
        case"contact":  renderContact();break;
        case"projects": renderProjects();break;
        default:        renderCommandNotFound();break}
    renderNewForm()
}
